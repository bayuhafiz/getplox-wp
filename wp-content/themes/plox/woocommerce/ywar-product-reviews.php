...
<div id="reviews">
	<h2><?php _e('Customer Reviews', 'plox') ?></h2>

	<?php if ( get_option( 'woocommerce_review_rating_verification_required' ) === 'no' || wc_customer_bought_product( '', get_current_user_id(), $product->id ) ) : ?>

		<button class="write-btn main-btn">Write a Review</button>
	...
	<div id="comments">
		<h4>
			...
			if ( get_option( 'woocommerce_enable_review_rating' ) === 'yes' && $reviews_count ) {
				printf( _n( 'Reviews (%s)', 'Reviews (%s)', $reviews_count, 'yith-woocommerce-advanced-reviews' ), $reviews_count, get_the_title() );
			} else {
