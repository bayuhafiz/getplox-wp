...
<table class="shop_table woocommerce-checkout-review-order-table">
	<thead>
		<tr class="cart-summary-heading">
			<th colspan="3"><?php _e( 'Cart Summary', 'woocommerce' ); ?></th>
		</tr>
		<tr>
	...
	<tfoot>
		<tr class="cost-summary-heading">
			<th colspan="3"><?php _e( 'Cost Summary', 'woocommerce' ); ?></th>
		</tr>
		<tr class="cart-subtotal">
			<th colspan="2"><?php _e( 'Merchandise Subtotal', 'woocommerce' ); ?></th>
