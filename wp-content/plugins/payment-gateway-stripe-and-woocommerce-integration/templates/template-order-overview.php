...
function eh_spg_list_order_table()
{
    ...
    <input id='display_count_order' style="width:132px" type='number' value="<?php $count=get_option('eh_order_table_row');if($count){echo $count;}?>" placeholder="Number of Rows">
