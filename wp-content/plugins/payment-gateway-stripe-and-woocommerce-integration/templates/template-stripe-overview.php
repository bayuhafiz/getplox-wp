...
function eh_spg_list_stripe_table()
{
    ...
    <input id='display_count_stripe' style="width:132px" type='number' value="<?php $count=get_option('eh_stripe_table_row');if($count){echo $count;}?>" placeholder="Number of Rows">
