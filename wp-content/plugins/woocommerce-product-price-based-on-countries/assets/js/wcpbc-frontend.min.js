jQuery(function(a){a(document.body).on("wcpbc_refresh_cart_fragments",function(){a.post(wc_cart_fragments_params.wc_ajax_url.toString().replace("%%endpoint%%","wc_price_based_country_refresh_cart"),function(b){var c=b.fragments;b=b.cart_hash;c&&a.each(c,function(b,c){a(b).replaceWith(c)});a(document.body).trigger("added_to_cart",[c,b])})});"undefined"!==typeof wcpbc_frontend_params&&a(document.body).trigger("wcpbc_refresh_cart_fragments");0<a("#calc_shipping_country").length&&a(document).ajaxSuccess(function(b,
